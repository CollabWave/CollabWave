...
export const BrandPersonalInfo = ({ user }) => {
  ...
  return (
    <>
      <div
        className={`${styles.backWrap} text-blue ${montserrat.className}`}
        onClick={() => router.back()}
      >
      ...
      <Col className={`${styles.rightSide} profile-card`}>
        ...
        >
          <Row gutter={{ xs: 10, md: 15, xl: 30 }}>
            ...
            <Col span={24}>
              <h3
                className={`${styles.heading} ${styles.headingMargin} ${montserrat.className} profile-heading`}
              >
                Contact Info
              </h3>
            </Col>
          ...
          <Row className={styles.headingMargin} gutter={[10, 10]} wrap={false}>
            <Col span={12}>
              <Button
